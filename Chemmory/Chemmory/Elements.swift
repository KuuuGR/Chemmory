...
var namesPL: [String] = ["Polski","Wodór","Hel","Lit","Beryl","Bor","Węgiel","Azot","Tlen","Fluor","Neon","Sód","Magnez","Aluminium","Krzem","Fosfor","Siarka","Chlor","Argon","Potas","Wapń","Scandium","Tytan","Wanad","Chrom","Mangan","Żelazo","Kobalt","Nikiel","Miedź","Cynk","Gal","German","Arsen","Selen","Brom","Krypton","Rubid","Stront","Itr","Cyrkon","Niob","Molibden","Technet","Ruten","Rod","Pallad","Srebro","Kadm","Ind","Cyna","Antymon","Tellur","Jod","Ksenon","Cez","Barium","Lantan","Cer","Praseodymium","Neodym","Prometium","Samarium","Europium","Gadolin","Terb","Dysproz","Holmium","Erb","Thulium","Yterter","Lutecium","Hafn","Tantal","Wolfram","Ren","Osm","Iridium","Platyna","Złoto","Rtęć","Tal","Ołów","Bizmut","Polon","Astat","Radon","Wapń","Rad","Aktyn","Thor","Protaktyn","Uran","Neptuni","Pluton","Americium","Curium","Berkelium","Californium","Einsteinium","Fermium","Mendelevium","Nobelium","Lawrencium","Rutherfordium","Dubnium","Seaborgium","Bohrium","Hassium","Meitnerium","Darmstadtium","Roentgenium","Copernicium"]

var namesEN: [String] = ["English","Hydrogen","Helium","Lithium","Beryllium","Boron","Carbon","Nitrogen","Oxygen","Fluorine","Neon","Sodium","Magnesium","Aluminum","Silicon","Phosphorus","Sulfur","Chlorine","Argon","Potassium","Calcium","Scandium","Titanium","Vanadium","Chromium","Manganese","Iron","Cobalt","Nickel","Copper","Zinc","Gallium","Germanium","Arsenic","Selenium","Bromine","Krypton","Rubidium","Strontium","Yttrium","Zirconium","Niobium","Molybdenum","Technetium","Ruthenium","Rhodium","Palladium","Silver","Cadmium","Indium","Tin","Antimony","Tellurium","Iodine","Xenon","Cesium","Barium","Lanthanum","Cerium","Praseodymium","Neodymium","Promethium","Samarium","Europium","Gadolinium","Terbium","Dysprosium","Holmium","Erbium","Thulium","Ytterbium","Lutecium","Hafnium","Tantalum","Tungsten","Rhenium","Osmium","Iridium","Platinum","Gold","Mercury","Thallium","Lead","Bismuth","Polonium","Astatine","Radon","Francium","Radium","Actinium","Thorium","Protactinium","Uranium","Neptunium","Plutonium","Americium","Curium","Berkelium","Californium","Einsteinium","Fermium","Mendelevium","Nobelium","Lawrencium","Rutherfordium","Dubnium","Seaborgium","Bohrium","Hassium","Meitnerium","Darmstadtium","Roentgenium","Copernicium"]

var namesRU: [String] = ["Русский","Водород","Гелий","Литий","Бериллий","Бор","Углерод","Азот","Кислород","Фтор","Неон","Натрий","Магний","алюминий","кремний","Фосфор","сера","хлор","Аргон","Калий","Кальций","Скандий","Титан","Ванадий","Хром","Марганец","Железный","Кобальт","никель","медь","галлия","ГерманийКобальт","НикельЦинк","Мышьяк","селена","Бром","Криптон","рубидий","Стронций","Иттрий","Цирконий","Ниобий","Молибден","Технеций","рутений","родий","Палладий","серебро","Кадмий","индий","Олово","сурьма","Теллур","Йод","ксенон","Цезий","Барий","Лантан","церий","Празеодим","неодим","Прометий","самарий","европий","гадолиний","тербий","диспрозий","Гольмиевый","эрбий","Тулий","Иттербий","лютеций","гафний","Тантал","Вольфрам","рений","осмий","","ПлатинаИридий","Золото","Меркурий","таллий","Свинец","Висмут","полоний","астат","Радон","Франций","Радий","актиний","Торий","протактиний","Уран","Neptunium","Плутоний","Americium","Curium","Берклий","калифорния","Эйнштейний","Fermium","Менделевий","Nobelium","Лоуренсий","резерфордия","Дубний","сиборгия","борий","ганий","мейтнерии","Darmstadtium","рентгения","Коперниции"]

var namesES: [String] = ["Español","Hidrógeno","Helio","Litio","Berilio","Boro","Carbono","Nitrógeno","Oxígeno","Flúor","Neón","Sodio","Magnesio","Aluminio","Silicio","Fósforo","Azufre","Cloro","Argón","Potasio","Calcio","Escandio","Titanio","Vanadio","Cromo","Manganeso","Hierro","Cobalto","Níquel","Cobre","Zinc","Galio","Germanio","Arsénico","Selenio","Bromo","Criptón","Rubidio","estroncio","itrio","circonio","niobio","molibdeno","tecnecio","rutenio","rodio","paladio","platino","cadmio","indio","Estaño","Antimonio","Telurio","Yodo","Xenón","Cesio","Bario","Lantano","Cerio","Praseodimio","Neodimio","Promethium","Samario","Europio","Gadolinio","Terbio","Disprosio","Holmio","Erbio","Tulio","Yterbio","Lutecium","Hafnio","Tantalio","Tungsteno","Renio","Osmio","Iridio","Platino","Oro","Mercurio","Talio","Plomo","Bismuto","Polonio","Astatino","Radón","Francium","Radium","Actinium","Thorium","Protactinium","Uranium","Neptunium","Plutonium","Americium","Curium","Berkelium","Californium","Einsteinium","Fermium","Mendelevium","Nobelium","Lawrencium","Rutherfordium","Dubnium","Seaborgium","Bohrium","Hassium","Meitnerium","Darmstadtium","Roentgenium","Copernicium"]

var namesFR: [String] = ["française","Hydrogène","Hélium","Lithium","Béryllium","Bore","Carbone","Azote","Oxygène","Fluor","Néon","Sodium","Magnésium","Aluminium","Silicium","Phosphore","Soufre","Chlore","Argon","Potassium","Calcium","Scandium","Titane","Vanadium","Chrome","Manganèse","Fer","Cobalt","Nickel","Cuivre","Zinc","Gallium","Germanium","Arsenic","Sélénium","Brome","Krypton","Rubidium","Strontium","Yttrium","Zirconium","Niobium","Molybdène","Technétium","Ruthénium","Rhodium","Palladium","Argent","Cadmium","Indium","Etain","Antimoine","Tellure","Iode","Xenon","Césium","Barium","Lanthane","Cérium","Praseodymium","Néodyme","Prométhium","Samarium","Europium","Gadolinium","Terbium","Dysprosium","Holmium","Erbium","Thulium","Ytterbium","Lutécium","Hafnium","Tantale","Tungsten","Rhénium","Osmium","Iridium","Platine","Or","Mercure","Thallium","Plomb","Bismuth","Polonium","Astatine","Radon","Francium","Radium","Actinium","Thorium","Protactinium","Uranium","Neptunium","Plutonium","Americium","Curium","Berkelium","Californium","Einsteinium","Fermium","Mendelevium","Nobelium","Lawrencium","Rutherfordium","Dubnium","Seaborgium","Bohrium","Hassium","Meitnerium","Darmstadtium","Roentgenium","Copernicium"]

var namesGE: [String] = ["Deutsche","Wasserstoff","Helium","Lithium","Beryllium","Bor","Kohlenstoff","Stickstoff","Sauerstoff","Fluor","Neon","Natrium","Magnesium","Aluminium","Silizium","Phosphor","Schwefel","Chlor","Argon","Kalium","Calcium","Scandium","Titan","Vanadium","Chrom","Mangan","Eisen","Kobalt","Nickel","Kupfer","Zink","Gallium","Germanium","Arsen","Selen","Brom","Krypton","Rubidium","Strontium","Yttrium","Zirkonium","Niob","Molybdän","Technetium","Ruthenium","Rhodium","Palladium","Silber","Cadmium","Indium","Zinn","Antimon","Tellurium","Jod","Xenon","Caesium","Barium","Lanthanum","Cer","Praseodymium","Neodymium","Promethium","Samarium","Europium","Gadolinium","Terbium","Dysprosium","Holmium","Erbium","Thulium","Ytterbium","Lutecium","Hafnium","Tantalum","Wolfram","Rhenium","Osmium","Iridium","Platin","Gold","Quecksilber","Thallium","Blei","Bismut","Polonium","Astatine","Radon","Francium","Radium","Actinium","Thorium","Protactinium","Uran","Neptunium","Plutonium","AmeRicium","Curium","Berkelium","Californium","Einsteinium","Fermium","Mendelevium","Nobelium","Lawrencium","Rutherfordium","Dubnium","Seaborgium","Bohrium","Hassium","Meitnerium","Darmstadtium","Roentgenium","Copernicium"]
